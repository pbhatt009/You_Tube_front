...
<div className="flex flex-col w-full h-full text-black">
 <div className="w-full h-10 flex  flex-col justify-around bg-gray-700">
    ...
    <button className="ml-10  bg-black text-white rounded-2xl h-10 w-20 flex justify-center items-center " >Videos</button>
    <button className="ml-10  bg-black text-white rounded-2xl h-10 w-20 flex justify-center items-center " >Channel</button>
 </div>
...
{loading ? (
  ...
  <div className="flex flex-wrap mt-5 gap-2 ml-2 mr-1 mb-5 overflow-y-auto">
    {videoarr.map((video) => {
